...
extern "C++" void lattice_filter_gpu(double * output, const double *input, const double *positions, int pd, int vd, int n);

extern "C++" void compute_bilateral_kernel_gpu(const float * reference, float * positions, int num_super_pixels, int n_reference_channels,
                                               int n_spatial_dims, const int *spatial_dims, float theta_alpha, float theta_beta);

extern "C++" void compute_bilateral_kernel_gpu(const double * reference, double * positions, int num_super_pixels, int n_reference_channels,
...
template<typename T> void bilateral_filter_gpu(T *input,
